...
**Slater's rules** (1930) generalize this to any electron in any atom. [verify: Slater, J.C. (1930). Physical Review, 36, 57–64.]
...
This must be stated honestly: **no one has derived the Madelung rule from first principles as of 2026.** The pattern was identified empirically by Charles Janet in 1929 and Erwin Madelung in 1936 and is confirmed by numerical Hartree-Fock calculations for most elements, but no analytic derivation from the Schrödinger equation exists. John Carlos Baez catalogued this as a genuine open problem in a 2021 survey. [verify: Baez, J.C. (2021), Azimuth blog] Use the rule as a reliable empirical pattern — not a derived theorem.
