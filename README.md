# Quantum Mechanics: Formalism and the Three-Dimensional Atom
...
- `images/quantum-mechanics-vol2-fig-NN.svg` — static SVG (→ PNG for EPUB)
- `d3/quantum-mechanics-vol2-fig-NN.html` — interactive D3 HTML
