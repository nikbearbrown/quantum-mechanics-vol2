...
- The chapter moves through Two values means two dimensions, Why spin is not rotation, Spin along any axis — the Bloch sphere, Spin in a magnetic field — Larmor precession, and related ideas.
...
![The original result: two spots where classical physics predicts a continuous smear. The image should make viscerally clear that the split is discrete, not broadened](../images/06-spin-fig-01.png)
*Figure 6.1 — Reproduction of the original 1922 Stern–Gerlach glass plate*
...
| Item | Meaning |
| --- | --- |
| "σ_i² = I for all i | A concrete checkpoint for applying the chapter concept. |
| σ_i σ_j = −σ_j σ_i for i≠j" | A concrete checkpoint for applying the chapter concept. |
...
![The spinning-ball picture requires superluminal surface speeds at every plausible electron radius. Smaller radii make it worse, not better](../images/06-spin-fig-02.png)
*Figure 6.2 — Log-scale bar chart comparing v_equator to c for*
...
![The Born rule on the Bloch sphere: probability depends only on the angle γ between state and analyzer, not on their absolute positions](../images/06-spin-fig-03.png)
*Figure 6.3 — Bloch sphere diagram annotated for the Born-rule geometry*
...
| particle | B₀ (T) | γ | (2π) (MHz | T or GHz |
| --- | --- | --- | --- | --- |
| electron at 1 mT, proton at 0.5 T (low-field MRI | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| proton at 1.5 T (clinical MRI | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| proton at 3 T (research MRI | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| proton at 7 T (ultra-high field | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| columns: particle, B₀ (T | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| γ | (2π) (MHz | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| f_L = ω_L | (2π | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| T_L = 1 | f_L | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |

![Larmor precession: θ₀ is frozen, φ advances at ω_L = γB₀. The state traces a latitude circle on the Bloch sphere](../images/06-spin-fig-04.png)
*Figure 6.4 — Bloch sphere showing Larmor precession *
...
![The intermediate SG_x measurement does not disturb a pre-existing z-value. It produces a state that has no definite z-value. The 50/50 outcome is structural, not accidental](../images/06-spin-fig-05.png)
*Figure 6.5 — Three-stage sequential SG diagram *
...
![The anomalous magnetic moment a_e is not an error. It is a precision test: QED and experiment agree to 13 significant figures](../images/06-spin-fig-06.png)
*Figure 6.6 — Conceptual diagram showing the layered structure of the*
...
![Target interface for the LLM exercise. Students should match this layout and verify the six checks before proceeding to the exploration tasks](../images/06-spin-fig-07.png)
*Figure 6.7 — Screenshot mockup of the completed 06-stern-gerlach*
