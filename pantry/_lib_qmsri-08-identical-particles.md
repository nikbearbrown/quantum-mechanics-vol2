...
- The chapter moves through What "identical" means, and why it matters, Antisymmetry built into the wave function, Pauli exclusion as a corollary, Helium and the exchange integral, and related ideas.
...
| spin | constituent fermion count | boson or fermion | key observable consequence (BEC | Pauli exclusion |
| --- | --- | --- | --- | --- |
| photon, electron, proton, neutron, ⁴He atom, ⁸⁷Rb atom | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| columns: spin, constituent fermion count, boson or fermion, key observable consequence (BEC, Pauli exclusion, superfluid transition temperature | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| student should see the composite-particle counting rule applied concretely | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
...
![The antisymmetry is in the algebra of the matrix, not imposed on the wave function by hand](../images/08-identical-particles-fig-01.png)
*Figure 8.1 — Visual derivation of the 2×2 Slater determinant *
...
![Not two elements — one element in two exchange-symmetry sectors, separated by the requirement that the total wave function be antisymmetric](../images/08-identical-particles-fig-02.png)
*Figure 8.2 — Helium symmetry sectors *
...
![The 2K splitting has no classical origin — it is the direct fingerprint of the exchange integral in the antisymmetrized wave function](../images/08-identical-particles-fig-03.png)
*Figure 8.3 — Helium 1s2s energy level diagram *
...
![Screening breaks the n²-fold hydrogen degeneracy: orbitals that penetrate closer to the nucleus are less shielded and fall lower in energy](../images/08-identical-particles-fig-04.png)
*Figure 8.4 — Radial probability density P(r) = r²|R_{nℓ}(r)|² for 3s,*
...
![Each row ends when a subshell is completely filled — two electrons per orbital (Pauli), parallel spins first (Hund)](../images/08-identical-particles-fig-05.png)
*Figure 8.5 — Aufbau filling diagram for the first 18 elements*
...
![The joint density encodes exchange statistics; the marginal does not. A single-particle detector cannot tell boson from fermion.](../images/08-identical-particles-fig-06.png)
*Figure 8.6 — Three 2D heat maps of |ψ(x₁,x₂)|² side by*
