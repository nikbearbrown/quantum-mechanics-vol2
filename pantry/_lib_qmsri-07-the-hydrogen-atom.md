...
- The chapter moves through One equation, two bodies, Separating the problem, The ground state, worked all the way through, Two radii, and why they differ, and related ideas.
...
| Item | Meaning |
| --- | --- |
| reduced mass μ (in units of m_e | A concrete checkpoint for applying the chapter concept. |
| Bohr radius a₀, ground-state energy E₁ (eV | A concrete checkpoint for applying the chapter concept. |
| Balmer α wavelength (nm | A concrete checkpoint for applying the chapter concept. |
...
![The centrifugal barrier suppresses the wave function near r = 0 for all ℓ ≥ 1. Only s-states (ℓ=0) reach the nucleus](../images/07-the-hydrogen-atom-fig-01.png)
*Figure 7.1 — V_eff(r) vs*
...
![The 1s wave function: spherically symmetric, maximum density at the nucleus, exponential decay in every direction. No ring, no orbit — just a probability cloud](../images/07-the-hydrogen-atom-fig-02.png)
*Figure 7.2 — 2D cross-section of |ψ_{100}|² in the xz-plane *
...
![Two numbers, one distribution. The peak at a₀ and the mean at 1.5 a₀ differ because P(r) is skewed. A path has one radius. A probability distribution does not](../images/07-the-hydrogen-atom-fig-03.png)
*Figure 7.3 — P(r) = r²|R_{10}(r)|² vs*
...
| n | allowed ℓ values | spectroscopic label for each (n | ℓ) pair | total orbital states n² |
| --- | --- | --- | --- | --- |
| for n = 1 through 4 — | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |

![All four n=2 states share E = −3.4 eV. Their shapes are entirely different](../images/07-the-hydrogen-atom-fig-04.png)
*Figure 7.4 — Gallery of 2D cross-sections of |ψ_{nℓm}(x,0,z)|² in the*
...
![Same subspace, two bases. Physics diagonalizes L_z. Chemistry maximizes spatial intuition for bonding](../images/07-the-hydrogen-atom-fig-05.png)
*Figure 7.5 — Comparison of the ℓ=1 subshell in two bases*
...
![The ℓ-degeneracy is a fingerprint of the pure 1/r potential. Sodium's D lines exist because sodium is not hydrogen](../images/07-the-hydrogen-atom-fig-06.png)
*Figure 7.6 — Energy level diagrams *
...
![Selection rules determine which transitions produce single photons. The 2s state is metastable because Δℓ=0 forbids direct decay to 1s](../images/07-the-hydrogen-atom-fig-07.png)
*Figure 7.7 — Hydrogen energy level diagram with allowed transitions drawn*
...
![The cloud shows where measurements land, not where charge sits](../images/07-the-hydrogen-atom-fig-08.png)
*Figure 7.8 — Misconception-vs-reality *
