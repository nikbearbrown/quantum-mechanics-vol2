...
- The chapter moves through The abstract state, Operators and Hermiticity, Commutators and why they matter, The qubit, and related ideas.
...
![Three identities that do all the computational work in any basis](../images/04-formalism-dirac-notation-and-operators-fig-01.png)
*Figure 4.1 — Diagram of the three identities side by side*
...
| position basis (diagonal matrix | entry x at position indexed by x | eigenvalue equation x̂|x⟩ = x|x⟩) |
| --- | --- | --- |
| "Same operator x̂, two bases" | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| footer: "The matrix depends on the basis. The operator does not. Verify: ⟨0/x̂/0⟩ = 0 in both representations" | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
...
![The factor of i in p̂ = −iℏ∂ₓ is not a convention. It is what makes momentum Hermitian and its eigenvalues real](../images/04-formalism-dirac-notation-and-operators-fig-02.png)
*Figure 4.2 — Two-column diagram contrasting Hermitian vs anti-Hermitian operators *
...
![No copy is measured twice. The bound is set by the state before measurement begins — it is not caused by measurement disturbance](../images/04-formalism-dirac-notation-and-operators-fig-03.png)
*Figure 4.3 — Ensemble-measurement diagram illustrating the Robertson protocol *
...
![Every pure qubit state is a point on the unit sphere. The angles θ/2 in the state become θ on the sphere via double-angle formulas](../images/04-formalism-dirac-notation-and-operators-fig-04.png)
*Figure 4.4 — Labeled Bloch sphere diagram *
...
| state | ⟨σ_y⟩ | σ_{σ_x} | σ_{σ_z} | σ_{σ_x}·σ_{σ_z} |
| --- | --- | --- | --- | --- |
| /0⟩ (north pole θ=0 | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| /+x⟩ (equator φ=0 | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| /+y⟩ (equator φ=π | 2 | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| /+⟩=(/0⟩+/1⟩) | √2 (equator φ=0 same as +x | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| columns: state, ⟨σ_y⟩, σ_{σ_x}, σ_{σ_z}, σ_{σ_x}·σ_{σ_z}, Robertson bound /⟨σ_y⟩/ | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| footer: "Bound is saturated (ratio = 1) exactly at the σ_y eigenstate. At the σ_z eigenstate the bound is 0 and is trivially satisfied" | student sees the bound is state-dependent, not a fixed number | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
