...
Before reading on: if we add a second electron, what changes? The new electron introduces a term in the Hamiltonian that doesn't appear in hydrogen. What does that term do to the elegant $\ell$-degeneracy?
